...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		// =====================================================================
		// SurplusToken: OAuth Provider Proxy (CPA management API forwarding)
		// Allows users to connect/disconnect OAuth upstream accounts.
		// =====================================================================
		oauthProviderRoute := apiRouter.Group("/oauth-provider")
		oauthProviderRoute.Use(middleware.UserAuth())
		{
			// List supported OAuth providers
			oauthProviderRoute.GET("/providers", controller.GetOAuthProviders)
			// Get OAuth authorization URL for a provider
			oauthProviderRoute.GET("/:provider/authorize", controller.GetOAuthAuthorizeURL)
			// List connected OAuth accounts (auth files)
